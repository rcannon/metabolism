...
# installed.
TCL_PREFIX='/people/cann484/metab/python/anaconda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/people/cann484/metab/python/anaconda'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /people/cann484/metab/python/anaconda/include -fdebug-prefix-map=/opt/conda/conda-bld/tk_1652087448741/work=/usr/local/src/conda/tk-8.6.11 -fdebug-prefix-map=/people/cann484/metab/python/anaconda=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /people/cann484/metab/python/anaconda/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/people/cann484/metab/python/anaconda/lib -Wl,-rpath-link,/people/cann484/metab/python/anaconda/lib -L/people/cann484/metab/python/anaconda/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/people/cann484/metab/python/anaconda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/people/cann484/metab/python/anaconda/include'
...
TCL_PACKAGE_PATH='{/people/cann484/metab/python/anaconda/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/people/cann484/metab/python/anaconda/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1652087448741/work/tcl8.6.11/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/people/cann484/metab/python/anaconda/lib/libtclstub8.6.a'
