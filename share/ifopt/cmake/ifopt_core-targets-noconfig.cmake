...
set_target_properties(ifopt::ifopt_core PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libifopt_core.so"
  IMPORTED_SONAME_NOCONFIG "libifopt_core.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ifopt::ifopt_core )
list(APPEND _IMPORT_CHECK_FILES_FOR_ifopt::ifopt_core "${_IMPORT_PREFIX}/lib64/libifopt_core.so" )
